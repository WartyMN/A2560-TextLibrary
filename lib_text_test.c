...
{
	mu_assert( Text_ShowFontChars(&global_screen[ID_CHANNEL_A], 10), "Could not show font chars for channel A" );
	mu_assert( Text_ShowFontChars(&global_screen[ID_CHANNEL_B], 10), "Could not show font chars for channel B" );
